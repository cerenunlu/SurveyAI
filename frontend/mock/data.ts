...
export const operations: Operation[] = [
  {
    ...
    surveyStatus: "Live",
    surveyGoal: "Track perception drift after pricing changes and support improvements.",
    surveyAudience: "Enterprise customers",
    surveyUpdatedAt: "2h ago",
    budget: "$42,000",
    reach: "54K",
    conversion: "18.2%",
    updatedAt: "45m ago",
  ...
  },
  {
    ...
    status: "Paused",
    surveyId: "trial-conversion-audit",
    survey: "Trial Conversion Audit",
    surveyStatus: "Draft",
    surveyGoal: "Validate where onboarding friction blocks trial-to-paid conversion.",
    surveyAudience: "New signups",
    surveyUpdatedAt: "6h ago",
    budget: "$19,500",
    reach: "18K",
    conversion: "12.7%",
    updatedAt: "3h ago",
  ...
  },
  {
    ...
    status: "Completed",
    surveyId: "nps-retention-loop",
    survey: "NPS Retention Loop",
    surveyStatus: "Live",
    surveyGoal: "Spot churn signals before renewal discussions begin.",
    surveyAudience: "Renewal accounts",
    surveyUpdatedAt: "1d ago",
    budget: "$28,300",
    reach: "31K",
    conversion: "21.9%",
    updatedAt: "1d ago",
